...
namespace newCRUD.Controllers
{
    ...
    public class MembersController : ControllerBase
    {
        ...
        {
            new Member { Id = Guid.NewGuid(), Email = "john@example.com", FullName = "John Doe", Active = true },
            new Member { Id = Guid.NewGuid(), Email = "jane@example.com", FullName = "Jane Smith", Active = false },
            new Member { Id = Guid.NewGuid(), Email = "maria@example.com", FullName = "Maria Lopez", Active = true },
            new Member { Id = Guid.NewGuid(), Email = "carlos@example.com", FullName = "Carlos Perez", Active = true }
        };
