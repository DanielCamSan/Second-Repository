...
namespace newCRUD.Controllers
{
    ...
    public class MembersController : ControllerBase
    {
        private static readonly List<Member> _members = new()
        {
            ...
            new Member { Id = Guid.NewGuid(), Email = "luis@example.com", FullName = "Luis Torres", Active = false },
        };
        ...
        // GET /api/v1/members?page=1&limit=5&sort=fullName&order=asc
        [HttpGet]
        ...
        )
        {
            ...
            // orden seguro por nombre de propiedad (case-insensitive)
